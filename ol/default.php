...
<html>
    <head>
        <title>Sveicnāti iekš <? print $host; ?>!</title>
    ...
    <body>
        <div id="main">
            <div id="content">
                <div class="header">
                    <a id="logo" href="http://www.hostinger.lv/"><img src="http://www.main-hosting.com/hostinger/welcome/images/logo.png" alt="Web hosting" /></a>
                </div>
                <div class="content">
                    <h1>Jūsu konts tika veiksmīgi izveidots!</h1>
                    <p>Mājas lapa <b><? print $host; ?></b> ir veiksmīgi uzstādīta uz servera! Lūdzu izdzēsiet <b>default.php</b> failu no public_html mapes un tad augšuplādējiet savu mājas lapu lietojot FTP vai Failu Pārvaldnieku.</p>
                    <p>Šeit ir saraksts ar failiem Jūsu public_html mapē:</p>
                    <div id="files">
                        <div class="top"></div>
                        <div class="cont">
            ...
            <div id="footer">
                <div class="links">
                    <a href="http://www.hostinger.lv/lapu-hostings" target="_blank">Mājas lapu Hostings</a> 
                    <span class="pipe">|</span> 
                    <a href="http://www.hostinger.lv/bezmaksas-hostings" target="_blank">Bezmaksas Hostings</a> 
                    <span class="pipe">|</span> 
                    <a href="http://www.hostinger.lv/forum" target="_blank">Palīdzības Forums</a> 
                    <span class="pipe">|</span> 
                    <a href="http://cpanel.hostinger.lv/" target="_blank">Client Login</a>
                </div>
                <div class="copyright">© <? print date('Y'); ?>. Visas tiesības rezervētas.</div>
                <div class="social-icons">
                    <a href="http://www.facebook.com/Hostinger.lv"><img src="http://www.main-hosting.com/hostinger/welcome/images/fb.gif" /></a>
